...
worktree_docker blooop/test_wtd@new_branch git status
...
OUTPUT=$(worktree_docker blooop/test_wtd@new_branch git status 2>&1)
...
worktree_docker --prune blooop/test_wtd@new_branch
...
if [ -d ~/.worktree_docker/workspaces/blooop/test_wtd/worktree-new_branch ]; then
...
worktree_docker blooop/test_wtd@new_branch git status > /dev/null
...
FINAL_OUTPUT=$(worktree_docker blooop/test_wtd@new_branch git status 2>&1)
