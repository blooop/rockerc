...
BUILD_OUTPUT=$(renv --nocache blooop/test_wtd@main git status 2>&1 || true)
...
FINAL_OUTPUT=$(renv blooop/test_wtd@main git status 2>&1)
...
# Test global flag
GLOBAL_OUTPUT=$(renv --nocache blooop/test_wtd@main echo "global nocache test" 2>&1 || true)
