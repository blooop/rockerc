...
LOAD_OUTPUT=$(timeout 60 worktree_docker --rebuild -e uv blooop/test_wtd@main echo "uv extension test" 2>&1 || true)
...
UV_TEST_OUTPUT=$(timeout 60 worktree_docker -e uv blooop/test_wtd@main which uv 2>&1 || true)
...
UV_FUNC_OUTPUT=$(timeout 60 worktree_docker -e uv blooop/test_wtd@main uv --help 2>&1 || true)
...
MULTI_EXT_OUTPUT=$(timeout 60 worktree_docker -e git -e uv blooop/test_wtd@main echo "multi-extension test" 2>&1 || true)
