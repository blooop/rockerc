...
#should enter on main repo @ branch test_branch1 and contain the folder "folder1"
renv blooop/test_renv@test_branch1 ls

#should enter on main repo @ branch test_branch1 in subfolder folder1 and contain the folder "folder2"
renv blooop/test_renv@test_branch1#folder1 ls

#should enter on main repo @ branch test_branch1 in subfolder folder1/folder2 and contain the file "example.txt"
renv blooop/test_renv@test_branch1#folder1/folder2 ls
