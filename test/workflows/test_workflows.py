...
def test_workflow_8_subfolder():
    ...
    expected_containers = [
        "test_renv-main-folder1-folder2",  # blooop/test_renv#folder1/folder2
        "test_renv-test_branch1",  # blooop/test_renv@test_branch1
        "test_renv-test_branch1-folder1",  # blooop/test_renv@test_branch1#folder1
        "test_renv-test_branch1-folder1-folder2",  # blooop/test_renv@test_branch1#folder1/folder2
        "test_renv-test_branch2-folder1-folder2",  # blooop/test_renv@test_branch2#folder1/folder2
    ]
