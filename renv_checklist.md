# worktree_docker Implementation Checklist for Claude Code
...
- [ ] Allow running commands directly in the container (e.g., `worktree_docker blooop/test_worktree_docker git status`)
- [ ] Support multi-stage commands (e.g., `worktree_docker blooop/test_worktree_docker "bash -c 'git status; pwd; ls -l'"`)
